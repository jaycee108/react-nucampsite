...
class Contact extends Component {
    ...
    handleSubmit(values) {
        postFeedback(values.firstName, values.lastName, values.phoneNum, values.email, values.agree, values.contactType, values.message, values.message, values.feedback, values.id);
    }
