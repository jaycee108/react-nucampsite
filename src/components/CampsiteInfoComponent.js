            ...
            <div>
                ...
                <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    ...
                    <ModalBody>
                        ...
                        <div className="form-group">
                            <Label htmpFor="author">Your Name </Label><br />
                            <Control.text name="author" placeholder= "Your Name" model=".author" id="author" className="form-control" 
                            validators={{
                        ...
                        <div className="form-group">
                            <Label htmpFor="text">Comment </Label><br />
